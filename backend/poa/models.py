...
class Obra(models.Model):
	...
	id_excel = models.IntegerField(null=True)            # col 0
	...
	capitulo_gasto = models.CharField(max_length=255, null=True, blank=True)    # col 6
	...
	proyecto_presupuesto = models.CharField(max_length=255, null=True, blank=True) # col 13
	...
	complejidad_tecnica = models.IntegerField(default=1)    # col 19 (Semáforo 1-5)
	...
	# --- BLOQUE 6: Ubicación e Impacto Territorial (Cols 34-37) ---
	...
	beneficiarios_num = models.BigIntegerField(default=0) # Sumatorias Dashboard
	...
	# --- BLOQUE 12: Comunicación y Narrativa Institucional (Cols 55-66) ---
